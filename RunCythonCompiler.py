...
""" Created on 30/03/2019   @author: Maurizio Ferrari Dacrema """
...
if __name__ == '__main__':
    ...
    subfolder_to_compile_list = ["Recommenders/MatrixFactorization", "Base/Similarity", "Recommenders/Slim/SlimBPR"]
    cython_file_list = []
