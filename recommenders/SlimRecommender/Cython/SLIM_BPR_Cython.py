...
class SLIM_BPR_Cython(BaseItemSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):
    ...
    def initSlimBPRCython(self, URM_train, verbose=False, free_mem_threshold=0.5, recompile_cython=False):
        # init of the class
        super(SLIM_BPR_Cython, self).initBaseSimilarityMatrixRecommender(URM_train, verbose=verbose)
    ...
    def fit(self, URM_train, epochs=300,
            ...
            symmetric=True,
            random_seed=None,
            batch_size=1000, lambda_i=0.0001, lambda_j=0.0001, learning_rate=1e-2, topK=200,
            sgd_mode='adagrad', gamma=0.995, beta_1=0.9, beta_2=0.999,
            **earlystopping_kwargs):

        self.initSlimBPRCython(URM_train)

        # Import compiled module
        from recommenders.SlimRecommender.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch
