...
# from MatrixFactorization_FunkSVD_Cython, MatrixFactorization_AsySVD_Cython
...
def runParameterSearch_Collaborative(recommender_class, URM_train, URM_train_last_test = None, metric_to_optimize = "PRECISION",
    ...
    try:
        ...
        if recommender_class in [ItemKNNCFRecommender]:
