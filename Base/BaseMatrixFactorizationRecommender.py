...
class BaseMatrixFactorizationRecommender(BaseRecommender):
    ...
    def initBaseMatrixFactorizationRecommender(self, URM_train, verbose):
        super(BaseMatrixFactorizationRecommender, self).initBaserecommender(URM_train, verbose=verbose)
        self.use_bias = False
