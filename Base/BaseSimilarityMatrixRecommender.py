""" Created on 16/09/2017   @author: Maurizio Ferrari Dacrema """

from Base.BaseRecommender import BaseRecommender
from Base.DataIO import DataIO
import numpy as np

# Class base Similarity Matrix
class BaseSimilarityMatrixRecommender(BaseRecommender):
    ...
    def initBaseSimilarityMatrixRecommender(self,URM_train, verbose=True):
        super(BaseSimilarityMatrixRecommender, self).initBaserecommender(URM_train, verbose = verbose)
